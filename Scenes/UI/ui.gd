...
func _unhandled_input(_event: InputEvent) -> void:
	if Input.is_action_just_released("rotate"):
		...
		print("selected building: ", tilemap.selected_building)
		# for straight roads
		if tilemap.selected_building == 6:
			tilemap.selected_building += 1
		elif tilemap.selected_building == 7:
			tilemap.selected_building -= 1
		# for L-shaped roads
		elif tilemap.selected_building == 9:
			tilemap.selected_building = 10
		elif tilemap.selected_building == 10:
			tilemap.selected_building = 12
		elif tilemap.selected_building == 11:
			tilemap.selected_building = 9
		elif tilemap.selected_building == 12:
			tilemap.selected_building = 11
		print("selected building: ", tilemap.selected_building)
...
func _on_button_up(building_name):
	tilemap.selected_building = buildings.find(building_name)
	can_place = true
